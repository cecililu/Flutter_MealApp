    ...
    return Scaffold(
        ...
        body: ListView.builder(
          itemBuilder: (context, index) {
            return MealItem(
              id: selected_meals[index].id,
              title: selected_meals[index].title,
              imageUrl: selected_meals[index].imageUrl,
              affordibility: selected_meals[index].affordability,
              complexity: selected_meals[index].complexity,
              duration: selected_meals[index].duration,
            );
          },
